                                    ...
                                    <td>
                                     ...
                                     <td>
                                       ...
                                       <template v-if="cursos.estado_curso == 1">
                                            <button type="button" class="btn btn-danger btn-sm"  @click="desactivarCurso(cursos.id, cursos.nombre_curso)">
                                                <i class="fa fa-times"></i>
                                            </button>
                                       </template>
                                      <template v-else-if="cursos.estado_curso == 2">
                                            <button type="button" class="btn btn-danger btn-sm" disabled>
                                                <!--@click="activarCurso(cursos.id)"-->
...
swalWithBootstrapButtons.fire({
  title: 'Esta seguro de desactivar este curso '+nombre+' ?',
                type: 'warning',
...
swalWithBootstrapButtons.fire({
       ...
       title: 'Esta seguro de activar este curso?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
