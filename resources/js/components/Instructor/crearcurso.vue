<template>
    <div class="row">
        <div class="col-md-12 center">
            <h2>¡Vamos a crear el curso!</h2>
            <p>Los campos señalados con (*), son obligatorios.</p>
        </div>
        <div class="col-md-12">
            <input type="text" v-model="titulo" @input="Slug" :class="'form-control '+classError" placeholder="TITULO DEL CURSO (*)"><br>
        </div>
            <div class="col-md-12">
                <input type="text" v-model="subtitulo" class="form-control" placeholder="Subtitulo del curso"> 
                <br>
            </div>
             <!-- <div class="col-md-12">
                <br><textarea  class="form-control" cols="30" rows="10" v-model="descripcion" placeholder="Descripción del curso"></textarea><br>
            </div> -->
            <div class="col-md-5">
            ...
            <div class="col-md-7">
              <textarea class="form-control" cols="30" rows="12" v-model="descripcion" placeholder="Descripción del curso"></textarea>
            </div>
            <div class="col-md-12">
                <div class="col-md-12 center">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                   <br> <input type="number" v-model="duracion" class="form-control" placeholder="Duracion del curso">
                </div>
                <div class="col-md-4">
                    <!-- tipo de duracion  -->
    ...
    methods:{
        ...
        previewV: function(){
            if(this.lCount===1){
                ...
                let linkVs = this.urlVideo;
                linkv = linkv.split('width="560"').join('width="100%"');
                linkv = linkv.split('height="315"').join('height="150"');
                this.preview = linkv;
                linkVs = linkVs.split('width="560"').join('width="100%"');
                linkVs = linkVs.split('height="315"').join('height="400"');
                this.HtmlVideo = linkVs;
            }else{
             ...
             this.HtmlVideo = '<video width="100%" height="400" src='+this.urlVideo+' controls autoplay>Tu navegador no implementa el elemento <code>video</code>.</video>';
            }
        },
        AgregarVI: function(){
            let _this = this;
        ...
        guardar: function(){
             ...
             if(_this.validar()){
                ...
                axios.post(url,{
                    ...
                    'introG':true,
                    'urlvideo':_this.HtmlVideo,
                    'descripcion_video':_this.descripcion_video,
                }).then(function(data){
                    let TextMessage ="Se ha guardado correctamente como borrador, hasta que que se apruebn los datos para activar el curso";
                    localStorage.setItem('CCurso', data.data.id);
