        ...
        <div class="col-md-4">
            ...
            <div class="thim-widget-heading thim-widget-heading-base template-base">
                <div class="sc_heading clone_title text-center ">
                    <h2 style="font-size:28px;font-weight:normal;font-style:inherit;" class="title">Mis Certificados</h2><div class="clone"></div></div></div>
            </div>
...
<div class="container">
    <br>
    <mis-Certificados idperson = "{{session()->get('id_persona')}}"></mis-Certificados>
</div>
@endsection