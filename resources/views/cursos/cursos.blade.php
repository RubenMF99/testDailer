        ...
        <div class="col-md-4">
            ...
            <div class="thim-widget-heading thim-widget-heading-base template-base">
                <div class="sc_heading clone_title  text-center">
                    <h2 style="text-transform: uppercase;font-size:28px;font-weight:normal;font-style:inherit;" class="title">Cursos</h2><div class="clone">Cursos</div></div></div>
            </div>
